<div class="bands index">
	...
	<tr>
		...
		<td><?php echo h($band['Band']['style']); ?>&nbsp;</td>
		<td><?php echo h($band['Band']['payment']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $band['Band']['id']), array(), __('Are you sure you want to delete # %s?', $band['Band']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
